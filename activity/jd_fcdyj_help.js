...
[task_local]
#发财大赢家
1 6-22/3 * * * jd_fcdyj_help.js, tag=发财大赢家助力, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "1 6-22/3 * * *" script-path=jd_fcdyj_help.js tag=发财大赢家助力

===============Surge=================
发财大赢家 = type=cron,cronexp="1 6-22/3 * * *",wake-system=1,timeout=3600,script-path=jd_fcdyj_help.js

============小火箭=========
发财大赢家 = type=cron,script-path=jd_fcdyj_help.js, cronexpr="1 6-22/3 * * *", timeout=3600, enable=true
 */
